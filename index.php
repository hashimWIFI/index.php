...
<button type="button" id="submit-payment-btn" class="btn-popup-pay" style="margin: 0; padding: 0 30px; background: #3498db; border-radius: 6px; font-size: 13px; color: white; font-weight: bold; min-width: 180px;" onclick="dispatchToRailway(event)">Pay</button></div></div></form>
...
<div class="section-title">2. Kuingia Mtandaoni, Bonyeza HODI;</div>
...
<!=========================================================================================================================================>     
            ...
            <article id="content4">
                    <form name="login" action="https://www.5wifi.net/login" method="post">
                    ...
                    <input type="hidden" name="submit" value="Log in" id="submit">
                </form>
       		                
 <p style="text-align:center; align-item: left; width: 100%; margin: 20px auto;"><a href="javascript:void(0);" onclick="return recharge(&#39;8600081897&#39;,&#39;24:EE:9A:7A:91:12&#39;);" id="topup_button"><span>🚀</span>HODI</a></p> </article></section>
