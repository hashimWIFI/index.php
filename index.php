...
<head>
    ...
    <title>TANConnect - Ukurasa Wa Malipo </title>
    <link rel="stylesheet" href="style.css">
    <script src="script.js"></script>
<style>
  .btn-portal { display: block; text-decoration: none; padding: 10px; font-size: 14px; width: flex; font-weight: bold; border-radius: 8px; text-transform: uppercase; letter-spacing: 0.5px; transition: transform 0.1s ease, filter 0.2s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.05); text-align: center; }
        .btn-portal:active { transform: scale(0.98); }
        .btn-portal:hover { filter: brightness(0.95); }
        .btn-buy { background-color: #3498db; color: black; border: 2px solid grey; }
</style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="portal-card">
            <img src="logo.png" alt=<b>"TANConnect"</b>style="max-width: 250px; height: auto; object-fit: contain; margin-bottom: 1px;">
            <div class="subtitle">
                <marquee behavior="scroll" direction="left" scrollamount="4" style="color: black; border-bottom: 2px solid #e2e8f0; font-weight: bold; font-size: 13px; margin-bottom: 10px;font-family: 'Segoe UI', Arial, sans-serif;">
                    Ndugu mteja, karibu kwenye mtandao wa Wi-Fi wa TANConnect || Tunakuletea internet isiyo na ukomo wa kasi kuperuzi mtandaoni || Fuata maelekezo hapa chini kununua Voucher kupitia simu yako ya mkononi || Kwa ufafanuzi, malalamiko au maelekezo zaidi, wasiliana nasi kwa nambari 0713 123 974 <br>
                </marquee> <br>
            </div>
...
<input class="btn-submit" name="customer_phone" id="phone-number" pattern="[0]{1}[6-7]{1}[0-9]{8}" type="tel" placeholder="0713123974" autocomplete="off" oninput="detectMobileProvider()" class="style-group" required/>

<button type="button" id="submit-payment-btn" class="btn-portal btn-buy1" onclick="dispatchToRailway(event)">PAY</button>                </div></div>
